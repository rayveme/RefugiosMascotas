...
const IMPACT: Record<number, Record<DonationFrequency, string>> = {
  5:   { once: 'Con $5 cubrirás la alimentación de una mascota por 1 día completo.',          monthly: 'Con $5/mes ayudarás al cuidado básico de una mascota todo el mes.' },
  10:  { once: 'Con $10 alimentarás a una mascota durante 3 días.',                           monthly: 'Con $10/mes cubrirás la alimentación de una mascota durante un mes.' },
  25:  { once: 'Con $25 cubrirás una consulta veterinaria de emergencia.',                    monthly: 'Con $25/mes cubrirás la alimentación de 2 mascotas durante un mes completo.' },
  50:  { once: 'Con $50 costearás la vacunación completa de una mascota.',                    monthly: 'Con $50/mes apoyarás el cuidado veterinario de 3 mascotas mensualmente.' },
  100: { once: 'Con $100 financiarás el rescate y atención inicial de una mascota en crisis.',monthly: 'Con $100/mes serás el padrino de 5 mascotas en cuidado intensivo.' },
};
...
export default function Donation() {
  ...
  const impactText = amount
    ? (IMPACT[amount]?.[freq] ?? `Tu donación de $${amount} marcará una diferencia real.`)
    : custom
      ...
      <div className="container donar-grid">
        ...
        <div className="reveal" ref={leftRef}>
          <div className="eyebrow">
            ...
            <span className="eyebrow__text">Haz la diferencia</span>
          </div>
          <h2 className="display-lg donar-headline" id="donar-title">
            Tu apoyo salva<br /><em>vidas reales</em>
          </h2>
          <p className="donar-desc">
            Cada donación contribuye directamente a la alimentación, cuidado veterinario y bienestar de miles de mascotas en situación de abandono a lo largo del país.
          </p>
        ...
        {/* Donation card */}
        <div className="reveal" ref={rightRef} style={{ transitionDelay: '.15s' }}>
          <div className="donar-card">
            <h3 className="donar-card__title">Hacer una donación</h3>
            <p className="donar-card__sub">100% va directamente a los refugios</p>

            {/* Frequency toggle */}
            <div className="freq-toggle" role="group" aria-label="Frecuencia de donación">
              <button
            ...
            {/* Amount grid */}
            <div className="amount-grid" role="group" aria-label="Seleccionar monto">
              {AMOUNTS.map(a => (
                <button
                  key={a}
            ...
            <button className="btn-donate" type="button">
              Donar ahora
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true" style={{ display: 'inline', verticalAlign: 'middle', marginLeft: 7 }}>
